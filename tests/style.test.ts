...
/**
 * The front of the page is layered: the lede hooks, the TL;DR answers, the
 * Summary argues, the parts show. Each layer has a length and a shape, and
 * the format is held here rather than remembered.
 */
